...
interface IGeneisNFTMirror {
    /**
     * @dev Assigns specified token IDs to a given account.
    ...
    /**
     * @dev Unassigns all tokens from a given account.
    ...
    /**
     * @dev Changes the governor address.
     * @param _governor Address of the new governor.
     */
    function changeGovernor(address _governor) external;

    /**
     * @dev Gets the name of the NFT mirror.
     * @return The name of the NFT mirror.
     */
    function name() external view returns (string memory);

    /**
     * @dev Gets the symbol of the NFT mirror.
     * @return The symbol of the NFT mirror.
     */
    function symbol() external view returns (string memory);

    /**
     * @dev Gets the total supply of tokens in the NFT mirror.
    ...
    /**
     * @dev Gets the token ID at a specific index in the list of all tokens.
    ...
    /**
     * @dev Gets the token ID at a specific index in the list of tokens owned by a specific address.
    ...
    /**
     * @dev Gets the index of the token owned by a specific address.
